...
contract NBAT001 is StandardToken, SafeMath {
  ...
  uint256 public constant GDCNumber1 = 200 * (10**factorial) * 10**decimals; //GDCAcc1????
  uint256 public constant GDCNumber2 = 200 * (10**factorial) * 10**decimals; //GDCAcc2????
  uint256 public constant GDCNumber3 = 200 * (10**factorial) * 10**decimals; //GDCAcc3????
  uint256 public constant GDCNumber4 = 200 * (10**factorial) * 10**decimals; //GDCAcc4????
  uint256 public constant GDCNumber5 = 200 * (10**factorial) * 10**decimals; //GDCAcc5????
