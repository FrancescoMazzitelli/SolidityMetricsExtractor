...
contract CPCE is StandardToken, SafeMath {
    ...
    uint256 public constant CPCEPrivate = 150 * (10**factorial) * 10**decimals; //150m?????????1.5???
    uint256 public constant CPCEIco = 150 * (10**factorial) * 10**decimals; //150m?ico???????1.5???
    uint256 public constant CPCEFund = 380 * (10**factorial) * 10**decimals; //380m?ico???????3.8???
