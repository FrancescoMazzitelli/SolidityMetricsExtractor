...
contract EDT is SafeMath {
    ...
    uint constant valueTotal = 15 * 10000 * 10000 * 10 ** 8;  //?? 15?
    uint constant valueSale = valueTotal / 100 * 50;  // ICO 50%
    uint constant valueVip = valueTotal / 100 * 40;   // ?? 40%
    uint constant valueTeam = valueTotal / 100 * 10;   // ?? 10%
