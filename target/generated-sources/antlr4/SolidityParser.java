...
public class SolidityParser extends Parser {
	...
	public final SourceUnitContext sourceUnit() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__78) | (1L << T__77) | (1L << T__71))) != 0) || _la==T__15 || _la==T__0) {
				{
				setState(151);
				switch (_input.LA(1)) {
				case T__71:
				...
				case T__15:
					{
					setState(150); definizioneContratto();
					}
					break;
				default:
	...
	public final PragmaContext pragma() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(158); match(T__71);
			setState(159); nomePragma();
			setState(160); valorePragma();
	...
	public final VersioneContext versione() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(169); vincoloVersione();
			setState(171);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__66) | (1L << T__63) | (1L << T__50) | (1L << T__48) | (1L << T__46) | (1L << T__25))) != 0) || _la==T__9 || _la==VersionLiteral) {
				{
				setState(170); vincoloVersione();
				}
			}
	...
	public final OperatoreVersioneContext operatoreVersione() throws RecognitionException {
		...
		try {
			...
			setState(173);
			_la = _input.LA(1);
			if ( !(((((_la - 15)) & ~0x3f) == 0 && ((1L << (_la - 15)) & ((1L << (T__66 - 15)) | (1L << (T__63 - 15)) | (1L << (T__50 - 15)) | (1L << (T__48 - 15)) | (1L << (T__46 - 15)) | (1L << (T__25 - 15)) | (1L << (T__9 - 15)))) != 0)) ) {
	...
	public final VincoloVersioneContext vincoloVersione() throws RecognitionException {
		...
		try {
			...
			if (((((_la - 15)) & ~0x3f) == 0 && ((1L << (_la - 15)) & ((1L << (T__66 - 15)) | (1L << (T__63 - 15)) | (1L << (T__50 - 15)) | (1L << (T__48 - 15)) | (1L << (T__46 - 15)) | (1L << (T__25 - 15)) | (1L << (T__9 - 15)))) != 0)) {
				{
				setState(175); operatoreVersione();
				}
			}

			setState(178); match(VersionLiteral);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final DichiarazioneImportContext dichiarazioneImport() throws RecognitionException {
		...
		try {
			...
			if (_la==T__37) {
				{
				setState(181); match(T__37);
				setState(182); identificatore();
				}
			}
	...
	public final ImportsContext imports() throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				setState(186); match(LiteralStringa);
				setState(189);
				_la = _input.LA(1);
				if (_la==T__37) {
					{
					setState(187); match(T__37);
					setState(188); identificatore();
					}
				}
			...
			case 2:
				...
				if (_la==T__37) {
					...
					setState(198); identificatore();
					}
				}

				setState(201); match(T__24);
				setState(202); match(LiteralStringa);
			...
			case 3:
				...
				while (_la==T__55) {
					{
					{
					setState(207); match(T__55);
					setState(208); dichiarazioneImport();
					}
					}
					setState(213);
					_errHandler.sync(this);
				...
				setState(215); match(T__24);
				setState(216); match(LiteralStringa);
	...
	public final DefinizioneContrattoContext definizioneContratto() throws RecognitionException {
		...
		try {
			...
			setState(221);
			_la = _input.LA(1);
			if ( !(((((_la - 3)) & ~0x3f) == 0 && ((1L << (_la - 3)) & ((1L << (T__78 - 3)) | (1L << (T__77 - 3)) | (1L << (T__15 - 3)))) != 0)) ) {
			_errHandler.recoverInline(this);
			}
			consume();
			setState(222); identificatore();
			setState(232);
			_la = _input.LA(1);
			if (_la==T__22) {
				{
				...
				while (_la==T__55) {
					{
					{
					setState(225); match(T__55);
					setState(226); inheritanceSpecifier();
					}
					}
					setState(231);
					_errHandler.sync(this);
			...
			setState(234); match(T__72);
			setState(238);
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__68) | (1L << T__62) | (1L << T__59) | (1L << T__51) | (1L << T__45) | (1L << T__43) | (1L << T__41) | (1L << T__40) | (1L << T__34) | (1L << T__27) | (1L << T__26) | (1L << T__24))) != 0) || ((((_la - 70)) & ~0x3f) == 0 && ((1L << (_la - 70)) & ((1L << (T__11 - 70)) | (1L << (T__10 - 70)) | (1L << (T__6 - 70)) | (1L << (T__4 - 70)) | (1L << (Int - 70)) | (1L << (Uint - 70)) | (1L << (Byte - 70)) | (1L << (Fixed - 70)) | (1L << (Ufixed - 70)) | (1L << (Identifier - 70)))) != 0)) {
				{
				{
				setState(235); parteDiContratto();
				}
				}
				setState(240);
				_errHandler.sync(this);
	...
	public final InheritanceSpecifierContext inheritanceSpecifier() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(243); tipiDefinitiUtente();
			setState(249);
			_la = _input.LA(1);
			if (_la==T__57) {
				{
				setState(244); match(T__57);
				setState(246);
				_la = _input.LA(1);
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__76) | (1L << T__68) | (1L << T__61) | (1L << T__57) | (1L << T__53) | (1L << T__51) | (1L << T__49) | (1L << T__46) | (1L << T__45) | (1L << T__42) | (1L << T__24))) != 0) || ((((_la - 65)) & ~0x3f) == 0 && ((1L << (_la - 65)) & ((1L << (T__16 - 65)) | (1L << (T__13 - 65)) | (1L << (T__11 - 65)) | (1L << (T__10 - 65)) | (1L << (T__8 - 65)) | (1L << (T__6 - 65)) | (1L << (T__1 - 65)) | (1L << (LiteralBooleano - 65)) | (1L << (NumeroDecimale - 65)) | (1L << (NumeroEsadecimale - 65)) | (1L << (LiteralEsadecimale - 65)) | (1L << (TypeKeyword - 65)) | (1L << (Int - 65)) | (1L << (Uint - 65)) | (1L << (Byte - 65)) | (1L << (Fixed - 65)) | (1L << (Ufixed - 65)) | (1L << (Identifier - 65)) | (1L << (LiteralStringa - 65)))) != 0)) {
					{
					setState(245); listaExpression();
					}
				}
	...
	public final ParteDiContrattoContext parteDiContratto() throws RecognitionException {
		...
		try {
			...
			case 1:
				enterOuterAlt(_localctx, 1);
				{
				setState(251); assegnazioneVariabile();
				}
				break;
			case 2:
				enterOuterAlt(_localctx, 2);
				{
				setState(252); usingForDeclaration();
				}
				break;
			case 3:
				enterOuterAlt(_localctx, 3);
				{
				setState(253); definizioneStruct();
				}
				break;
			case 4:
				enterOuterAlt(_localctx, 4);
				{
				setState(254); definizioneCostruttore();
				}
				break;
			case 5:
				enterOuterAlt(_localctx, 5);
				{
				setState(255); definizioneModifier();
				}
				break;
			case 6:
				enterOuterAlt(_localctx, 6);
				{
				setState(256); definizioneFunzione();
				}
				break;
			case 7:
				enterOuterAlt(_localctx, 7);
				{
				setState(257); definizioneErrore();
				}
				break;
			case 8:
				enterOuterAlt(_localctx, 8);
				{
				setState(258); definizioneEvento();
				}
				break;
			case 9:
				enterOuterAlt(_localctx, 9);
				{
				setState(259); definizioneEnum();
				}
				break;
			}
		}
	...
	public final AssegnazioneVariabileContext assegnazioneVariabile() throws RecognitionException {
		...
		try {
			...
			setState(269); identificatore();
			setState(272);
			_la = _input.LA(1);
			if (_la==T__66) {
				{
				setState(270); match(T__66);
	...
	public final UsingForDeclarationContext usingForDeclaration() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(276); match(T__34);
			setState(277); identificatore();
			setState(278); match(T__64);
			setState(281);
			switch (_input.LA(1)) {
			case T__21:
				{
	...
	public final DefinizioneStructContext definizioneStruct() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(285); match(T__40);
			setState(286); identificatore();
			setState(287); match(T__72);
			setState(298);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__68) | (1L << T__51) | (1L << T__45) | (1L << T__43) | (1L << T__41) | (1L << T__24))) != 0) || ((((_la - 70)) & ~0x3f) == 0 && ((1L << (_la - 70)) & ((1L << (T__11 - 70)) | (1L << (T__10 - 70)) | (1L << (T__6 - 70)) | (1L << (Int - 70)) | (1L << (Uint - 70)) | (1L << (Byte - 70)) | (1L << (Fixed - 70)) | (1L << (Ufixed - 70)) | (1L << (Identifier - 70)))) != 0)) {
				{
				setState(288); dichiarazioneVariabile();
				setState(289); match(T__32);
				setState(295);
				_errHandler.sync(this);
				_la = _input.LA(1);
				while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__68) | (1L << T__51) | (1L << T__45) | (1L << T__43) | (1L << T__41) | (1L << T__24))) != 0) || ((((_la - 70)) & ~0x3f) == 0 && ((1L << (_la - 70)) & ((1L << (T__11 - 70)) | (1L << (T__10 - 70)) | (1L << (T__6 - 70)) | (1L << (Int - 70)) | (1L << (Uint - 70)) | (1L << (Byte - 70)) | (1L << (Fixed - 70)) | (1L << (Ufixed - 70)) | (1L << (Identifier - 70)))) != 0)) {
					{
					{
					setState(290); dichiarazioneVariabile();
					setState(291); match(T__32);
					}
					}
					setState(297);
					_errHandler.sync(this);
	...
	public final DefinizioneCostruttoreContext definizioneCostruttore() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(302); match(T__59);
			setState(303); listaParametri();
			setState(304); listaModifier();
			setState(305); block();
			}
		}
		catch (RecognitionException re) {
	...
	public final DefinizioneModifierContext definizioneModifier() throws RecognitionException {
		...
		try {
			...
			setState(308); identificatore();
			setState(310);
			_la = _input.LA(1);
			if (_la==T__57) {
				{
				setState(309); listaParametri();
				}
			}
	...
	public final InvocazioneModifierContext invocazioneModifier() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(314); identificatore();
			setState(320);
			_la = _input.LA(1);
			if (_la==T__57) {
				{
				setState(315); match(T__57);
				setState(317);
				_la = _input.LA(1);
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__76) | (1L << T__68) | (1L << T__61) | (1L << T__57) | (1L << T__53) | (1L << T__51) | (1L << T__49) | (1L << T__46) | (1L << T__45) | (1L << T__42) | (1L << T__24))) != 0) || ((((_la - 65)) & ~0x3f) == 0 && ((1L << (_la - 65)) & ((1L << (T__16 - 65)) | (1L << (T__13 - 65)) | (1L << (T__11 - 65)) | (1L << (T__10 - 65)) | (1L << (T__8 - 65)) | (1L << (T__6 - 65)) | (1L << (T__1 - 65)) | (1L << (LiteralBooleano - 65)) | (1L << (NumeroDecimale - 65)) | (1L << (NumeroEsadecimale - 65)) | (1L << (LiteralEsadecimale - 65)) | (1L << (TypeKeyword - 65)) | (1L << (Int - 65)) | (1L << (Uint - 65)) | (1L << (Byte - 65)) | (1L << (Fixed - 65)) | (1L << (Ufixed - 65)) | (1L << (Identifier - 65)) | (1L << (LiteralStringa - 65)))) != 0)) {
					{
					setState(316); listaExpression();
					}
				}
	...
	public final DefinizioneFunzioneContext definizioneFunzione() throws RecognitionException {
		...
		try {
			...
			if (_la==T__45 || _la==T__24 || _la==Identifier) {
				{
				setState(323); identificatore();
				}
			}

			setState(326); listaParametri();
			setState(327); listaModifier();
			setState(329);
			_la = _input.LA(1);
			if (_la==T__44) {
				{
				setState(328); valoreRitorno();
				}
			}
	...
	public final DefinizioneErroreContext definizioneErrore() throws RecognitionException {
		...
		try {
			...
			if (_la==T__45 || _la==T__24 || _la==Identifier) {
				{
				setState(336); identificatore();
				}
			}

			setState(339); listaParametri();
			setState(340); match(T__32);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final ValoreRitornoContext valoreRitorno() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(342); match(T__44);
			setState(343); listaParametri();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final ListaModifierContext listaModifier() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (_la==T__45 || _la==T__24 || ((((_la - 91)) & ~0x3f) == 0 && ((1L << (_la - 91)) & ((1L << (ConstantKeyword - 91)) | (1L << (ExternalKeyword - 91)) | (1L << (InternalKeyword - 91)) | (1L << (PayableKeyword - 91)) | (1L << (PrivateKeyword - 91)) | (1L << (PublicKeyword - 91)) | (1L << (PureKeyword - 91)) | (1L << (ViewKeyword - 91)) | (1L << (Identifier - 91)))) != 0)) {
				{
				setState(351);
				switch (_input.LA(1)) {
				case T__45:
				...
				case Identifier:
					{
					setState(345); invocazioneModifier();
					}
					break;
				...
				case ViewKeyword:
					{
					setState(346); stateMutability();
					}
					break;
				case ExternalKeyword:
					{
					setState(347); match(ExternalKeyword);
					}
					break;
				case PublicKeyword:
					{
					setState(348); match(PublicKeyword);
					}
					break;
				case InternalKeyword:
					{
					setState(349); match(InternalKeyword);
					}
					break;
				case PrivateKeyword:
					{
					setState(350); match(PrivateKeyword);
					}
					break;
				default:
					throw new NoViableAltException(this);
	...
	public final DefinizioneEventoContext definizioneEvento() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(356); match(T__26);
			setState(357); identificatore();
			setState(358); listaParametriEvent();
			setState(360);
			_la = _input.LA(1);
			if (_la==AnonymousKeyword) {
				{
				setState(359); match(AnonymousKeyword);
				}
			}
	...
	public final DefinizioneEnumContext definizioneEnum() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(366); match(T__27);
			setState(367); identificatore();
			setState(368); match(T__72);
			setState(370);
			_la = _input.LA(1);
			if (_la==T__45 || _la==T__24 || _la==Identifier) {
				{
				setState(369); valoreEnum();
				}
			}
			...
			while (_la==T__55) {
				{
				{
				setState(372); match(T__55);
				setState(373); valoreEnum();
				}
				}
				setState(378);
				_errHandler.sync(this);
		...
		try {
			...
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__68) | (1L << T__51) | (1L << T__45) | (1L << T__43) | (1L << T__41) | (1L << T__24))) != 0) || ((((_la - 70)) & ~0x3f) == 0 && ((1L << (_la - 70)) & ((1L << (T__11 - 70)) | (1L << (T__10 - 70)) | (1L << (T__6 - 70)) | (1L << (Int - 70)) | (1L << (Uint - 70)) | (1L << (Byte - 70)) | (1L << (Fixed - 70)) | (1L << (Ufixed - 70)) | (1L << (Identifier - 70)))) != 0)) {
				...
				while (_la==T__55) {
					{
					{
					setState(383); match(T__55);
					setState(384); parametro();
					}
					}
					setState(389);
					_errHandler.sync(this);
	...
	public final ParametroContext parametro() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(394); nomeTipo(0);
			setState(396);
			switch ( getInterpreter().adaptivePredict(_input,36,_ctx) ) {
			case 1:
				{
				setState(395); tipoStorage();
				}
				break;
			}
			setState(399);
	...
	public final ParametriEventContext parametriEvent() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(414); nomeTipo(0);
			setState(416);
			_la = _input.LA(1);
			if (_la==IndexedKeyword) {
				{
				setState(415); match(IndexedKeyword);
				}
			}
	...
	public final ListaParametriFunzioneContext listaParametriFunzione() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(421); match(T__57);
			setState(430);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__68) | (1L << T__51) | (1L << T__45) | (1L << T__43) | (1L << T__41) | (1L << T__24))) != 0) || ((((_la - 70)) & ~0x3f) == 0 && ((1L << (_la - 70)) & ((1L << (T__11 - 70)) | (1L << (T__10 - 70)) | (1L << (T__6 - 70)) | (1L << (Int - 70)) | (1L << (Uint - 70)) | (1L << (Byte - 70)) | (1L << (Fixed - 70)) | (1L << (Ufixed - 70)) | (1L << (Identifier - 70)))) != 0)) {
				{
				setState(422); parametroFunzione();
				setState(427);
				_errHandler.sync(this);
				_la = _input.LA(1);
				while (_la==T__55) {
					{
					{
					setState(423); match(T__55);
					setState(424); parametroFunzione();
					}
					}
					setState(429);
					_errHandler.sync(this);
	...
	public final ParametroFunzioneContext parametroFunzione() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(434); nomeTipo(0);
			setState(436);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__75) | (1L << T__52) | (1L << T__45))) != 0)) {
				{
				setState(435); tipoStorage();
				}
			}
	...
	public final DichiarazioneVariabileContext dichiarazioneVariabile() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(438); nomeTipo(0);
			setState(440);
			switch ( getInterpreter().adaptivePredict(_input,45,_ctx) ) {
			case 1:
				{
				setState(439); tipoStorage();
				}
				break;
			}
			setState(442); identificatore();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	private NomeTipoContext nomeTipo(int _p) throws RecognitionException {
		...
		try {
			...
			case 1:
				{
				setState(445); tipiPrimitivi();
				}
				break;
			case 2:
				{
				setState(446); tipiDefinitiUtente();
				}
				break;
			case 3:
				{
				setState(447); mapping();
				}
				break;
			case 4:
				{
				setState(448); functionTypeName();
				}
				break;
			case 5:
				{
				setState(449); match(T__11);
				setState(450); match(PayableKeyword);
				}
				break;
			}
		...
		try {
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					{
					{
					setState(465); match(T__19);
					setState(466); identificatore();
					}
					} 
				}
				setState(471);
	...
	public final MappingContext mapping() throws RecognitionException {
		...
		try {
			...
			setState(473); match(T__57);
			setState(474); tipiPrimitivi();
			setState(475); match(T__7);
			setState(476); nomeTipo(0);
		...
		try {
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					case InternalKeyword:
						{
						setState(481); match(InternalKeyword);
						}
						break;
					case ExternalKeyword:
						{
						setState(482); match(ExternalKeyword);
						}
						break;
					case ConstantKeyword:
					case PayableKeyword:
			...
			case 1:
				{
				setState(489); match(T__44);
				setState(490); listaParametriFunzione();
				}
				break;
			}
			}
	...
	public final BlockContext block() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(497); match(T__72);
			setState(501);
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__76) | (1L << T__73) | (1L << T__72) | (1L << T__68) | (1L << T__64) | (1L << T__61) | (1L << T__58) | (1L << T__57) | (1L << T__53) | (1L << T__51) | (1L << T__49) | (1L << T__46) | (1L << T__45) | (1L << T__43) | (1L << T__42) | (1L << T__41) | (1L << T__35) | (1L << T__29) | (1L << T__24) | (1L << T__20) | (1L << T__18))) != 0) || ((((_la - 65)) & ~0x3f) == 0 && ((1L << (_la - 65)) & ((1L << (T__16 - 65)) | (1L << (T__13 - 65)) | (1L << (T__11 - 65)) | (1L << (T__10 - 65)) | (1L << (T__8 - 65)) | (1L << (T__6 - 65)) | (1L << (T__1 - 65)) | (1L << (LiteralBooleano - 65)) | (1L << (NumeroDecimale - 65)) | (1L << (NumeroEsadecimale - 65)) | (1L << (LiteralEsadecimale - 65)) | (1L << (BreakKeyword - 65)) | (1L << (ContinueKeyword - 65)) | (1L << (TypeKeyword - 65)) | (1L << (Int - 65)) | (1L << (Uint - 65)) | (1L << (Byte - 65)) | (1L << (Fixed - 65)) | (1L << (Ufixed - 65)) | (1L << (Identifier - 65)) | (1L << (LiteralStringa - 65)))) != 0)) {
				{
				{
				setState(498); statement();
				}
				}
				setState(503);
				_errHandler.sync(this);
	...
	public final StatementContext statement() throws RecognitionException {
		...
		try {
			...
			case T__73:
				enterOuterAlt(_localctx, 2);
				{
				setState(507); whileStatement();
				}
				break;
			case T__64:
				enterOuterAlt(_localctx, 3);
				{
				setState(508); forStatement();
				}
				break;
			case T__72:
				enterOuterAlt(_localctx, 4);
			...
			case T__58:
				enterOuterAlt(_localctx, 5);
				{
				setState(510); doWhileStatement();
				}
				break;
			case ContinueKeyword:
				enterOuterAlt(_localctx, 6);
				{
				setState(511); continueStatement();
				}
				break;
			case BreakKeyword:
				enterOuterAlt(_localctx, 7);
				{
				setState(512); breakStatement();
				}
				break;
			case T__35:
				enterOuterAlt(_localctx, 8);
				{
				setState(513); returnStatement();
				}
				break;
			case T__18:
				enterOuterAlt(_localctx, 9);
				{
				setState(514); throwStatement();
				}
				break;
			case T__20:
				enterOuterAlt(_localctx, 10);
				{
				setState(515); emitStatement();
				}
				break;
			case T__76:
			case T__68:
	...
	public final IfStatementContext ifStatement() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(522); match(T__29);
			setState(523); match(T__57);
	...
	public final SimpleStatementContext simpleStatement() throws RecognitionException {
		...
		try {
			...
			case 1:
				{
				setState(537); dichiarazioneVariabileStatement();
				}
				break;
			case 2:
				{
				setState(538); expressionStatement();
				}
				break;
			}
			}
	...
	public final ForStatementContext forStatement() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(541); match(T__64);
			setState(542); match(T__57);
			setState(545);
			switch (_input.LA(1)) {
			case T__76:
			case T__68:
			...
			case LiteralStringa:
				{
				setState(543); simpleStatement();
				}
				break;
			case T__32:
				{
				setState(544); match(T__32);
				}
				break;
			default:
				throw new NoViableAltException(this);
			...
			case LiteralStringa:
				{
				setState(547); expressionStatement();
				}
				break;
			case T__32:
				{
	...
	public final DoWhileStatementContext doWhileStatement() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(557); match(T__58);
			setState(558); statement();
			setState(559); match(T__73);
			setState(560); match(T__57);
			setState(561); expression(0);
			setState(562); match(T__2);
			setState(563); match(T__32);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final ContinueStatementContext continueStatement() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(565); match(ContinueKeyword);
			setState(566); match(T__32);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final BreakStatementContext breakStatement() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(568); match(BreakKeyword);
			setState(569); match(T__32);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final ThrowStatementContext throwStatement() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(577); match(T__18);
			setState(578); match(T__32);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final EmitStatementContext emitStatement() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(580); match(T__20);
			setState(581); chiamataFunzione();
			setState(582); match(T__32);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final DichiarazioneVariabileStatementContext dichiarazioneVariabileStatement() throws RecognitionException {
		...
		try {
			...
			case 1:
				{
				setState(584); match(T__51);
				setState(585); listaIdentifier();
				}
				break;
			case 2:
				{
				setState(586); dichiarazioneVariabile();
				}
				break;
			case 3:
				{
				setState(587); match(T__57);
				setState(588); listaDichiarazioneVariabili();
			...
			if (_la==T__66) {
				{
				setState(593); match(T__66);
				setState(594); expression(0);
				}
			}

			setState(597); match(T__32);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final ListaDichiarazioneVariabiliContext listaDichiarazioneVariabili() throws RecognitionException {
		...
		try {
			...
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__68) | (1L << T__51) | (1L << T__45) | (1L << T__43) | (1L << T__41) | (1L << T__24))) != 0) || ((((_la - 70)) & ~0x3f) == 0 && ((1L << (_la - 70)) & ((1L << (T__11 - 70)) | (1L << (T__10 - 70)) | (1L << (T__6 - 70)) | (1L << (Int - 70)) | (1L << (Uint - 70)) | (1L << (Byte - 70)) | (1L << (Fixed - 70)) | (1L << (Ufixed - 70)) | (1L << (Identifier - 70)))) != 0)) {
				{
				setState(599); dichiarazioneVariabile();
				}
			}
			...
			while (_la==T__55) {
				{
				{
				setState(602); match(T__55);
				setState(604);
				_la = _input.LA(1);
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__68) | (1L << T__51) | (1L << T__45) | (1L << T__43) | (1L << T__41) | (1L << T__24))) != 0) || ((((_la - 70)) & ~0x3f) == 0 && ((1L << (_la - 70)) & ((1L << (T__11 - 70)) | (1L << (T__10 - 70)) | (1L << (T__6 - 70)) | (1L << (Int - 70)) | (1L << (Uint - 70)) | (1L << (Byte - 70)) | (1L << (Fixed - 70)) | (1L << (Ufixed - 70)) | (1L << (Identifier - 70)))) != 0)) {
					{
					setState(603); dichiarazioneVariabile();
					}
				}
		...
		try {
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					if (_la==T__45 || _la==T__24 || _la==Identifier) {
						{
						setState(612); identificatore();
						}
					}

					setState(615); match(T__55);
					}
					} 
				}
				setState(620);
			...
			if (_la==T__45 || _la==T__24 || _la==Identifier) {
				{
				setState(621); identificatore();
				}
			}

			setState(624); match(T__2);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	private ExpressionContext expression(int _p) throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				case T__49:
					{
					setState(627); incremento();
					}
					break;
				case T__13:
					{
					setState(628); decremento();
					}
					break;
				default:
					throw new NoViableAltException(this);
				}
				setState(631); expression(19);
				}
				break;
			case 2:
				{
				{
				setState(633); operatoriSomma();
				}
				setState(634); expression(18);
				}
				break;
			case 3:
				{
				...
				consume();
				setState(637); expression(17);
				}
				break;
			case 4:
				{
				setState(638); match(T__8);
				setState(639); expression(16);
				}
				break;
			case 5:
				{
				setState(640); match(T__46);
				setState(641); expression(15);
				}
				break;
			case 6:
				{
				setState(642); match(T__76);
				setState(643); nomeTipo(0);
				}
				break;
			case 7:
				{
				setState(644); match(T__57);
			...
			case 8:
				{
				setState(648); primaryExpression();
				}
				break;
			}
			_ctx.stop = _input.LT(-1);
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					case 1:
						...
						setState(652); potenza();
						setState(653); expression(15);
						}
						break;
					case 2:
						{
						...
						{
						setState(656); operatoriMoltiplicazione();
						}
						setState(657); expression(14);
						}
						break;
					case 3:
						{
						...
						{
						setState(660); operatoriSomma();
						}
						setState(661); expression(13);
						}
						break;
					case 4:
						{
						...
						setState(664);
						_la = _input.LA(1);
						if ( !(_la==T__67 || _la==T__31) ) {
						_errHandler.recoverInline(this);
						}
						consume();
						setState(665); expression(12);
						}
						break;
					case 5:
						{
					...
					case 7:
						...
						setState(673); match(T__12);
						setState(674); expression(9);
						}
						break;
					case 8:
						{
						...
						{
						setState(676); operatoriRelazionali();
						}
						setState(677); expression(8);
						}
						break;
					case 9:
						{
						...
						{
						setState(680); operatoriConfrontoDiretto();
						}
						setState(681); expression(7);
						}
						break;
					case 10:
						{
						...
						setState(684); match(AND);
						setState(685); expression(6);
						}
						break;
					case 11:
						{
						...
						setState(687); match(OR);
						setState(688); expression(5);
						}
						break;
					case 12:
						{
						...
						setState(689);
						if (!(precpred(_ctx, 3))) throw new FailedPredicateException(this, "precpred(_ctx, 3)");
						setState(690); match(T__28);
						setState(691); expression(0);
						setState(692); match(T__17);
						setState(693); expression(4);
						}
						break;
					case 13:
						{
						...
						{
						setState(696); operatoriAssegnazione();
						}
						setState(697); expression(3);
						}
						break;
					case 14:
						{
						...
						case T__49:
							{
							setState(700); incremento();
							}
							break;
						case T__13:
							{
							setState(701); decremento();
							}
							break;
						default:
							throw new NoViableAltException(this);
					...
					case 16:
						...
						setState(710); match(T__57);
						setState(711); argomentiChiamataFunzione();
						setState(712); match(T__2);
						}
						break;
					case 17:
						{
	...
	public final PrimaryExpressionContext primaryExpression() throws RecognitionException {
		...
		try {
			...
			case 1:
				enterOuterAlt(_localctx, 1);
				{
				setState(722); match(LiteralBooleano);
				}
				break;
			case 2:
				enterOuterAlt(_localctx, 2);
				{
				setState(723); valoreNumerico();
				}
				break;
			case 3:
				enterOuterAlt(_localctx, 3);
				{
				setState(724); match(LiteralEsadecimale);
				}
				break;
			case 4:
				enterOuterAlt(_localctx, 4);
				{
				setState(725); match(LiteralStringa);
				}
				break;
			case 5:
				enterOuterAlt(_localctx, 5);
				{
				setState(726); identificatore();
				setState(729);
				switch ( getInterpreter().adaptivePredict(_input,74,_ctx) ) {
				case 1:
					{
					setState(727); match(T__16);
					setState(728); match(T__47);
					}
					break;
				}
				}
			...
			case 6:
				enterOuterAlt(_localctx, 6);
				{
				setState(731); match(TypeKeyword);
				}
				break;
			case 7:
				enterOuterAlt(_localctx, 7);
				{
				setState(732); tupleExpression();
				}
				break;
			case 8:
				enterOuterAlt(_localctx, 8);
				{
				setState(733); tipiExpression();
				setState(736);
				switch ( getInterpreter().adaptivePredict(_input,75,_ctx) ) {
				case 1:
					{
					setState(734); match(T__16);
					setState(735); match(T__47);
					}
					break;
				}
				}
		...
		try {
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					{
					{
					setState(749); match(T__55);
					setState(750); nameValue();
					}
					} 
				}
				setState(755);
	...
	public final NameValueContext nameValue() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(759); identificatore();
			setState(760); match(T__17);
	...
	public final ArgomentiChiamataFunzioneContext argomentiChiamataFunzione() throws RecognitionException {
		...
		try {
			...
			case T__72:
				enterOuterAlt(_localctx, 1);
				{
				setState(763); match(T__72);
				setState(765);
				_la = _input.LA(1);
				if (_la==T__45 || _la==T__24 || _la==Identifier) {
					{
					setState(764); listaNameValue();
					}
				}

				setState(767); match(T__30);
				}
				break;
			case T__76:
			case T__68:
	...
	public final ChiamataFunzioneContext chiamataFunzione() throws RecognitionException {
		...
		try {
			...
			setState(774); match(T__57);
			setState(775); argomentiChiamataFunzione();
			setState(776); match(T__2);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final TupleExpressionContext tupleExpression() throws RecognitionException {
		...
		try {
			...
			case T__57:
				...
				setState(791); match(T__2);
				}
				break;
			case T__16:
				enterOuterAlt(_localctx, 2);
				{
				setState(792); match(T__16);
				setState(801);
				_la = _input.LA(1);
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__76) | (1L << T__68) | (1L << T__61) | (1L << T__57) | (1L << T__53) | (1L << T__51) | (1L << T__49) | (1L << T__46) | (1L << T__45) | (1L << T__42) | (1L << T__24))) != 0) || ((((_la - 65)) & ~0x3f) == 0 && ((1L << (_la - 65)) & ((1L << (T__16 - 65)) | (1L << (T__13 - 65)) | (1L << (T__11 - 65)) | (1L << (T__10 - 65)) | (1L << (T__8 - 65)) | (1L << (T__6 - 65)) | (1L << (T__1 - 65)) | (1L << (LiteralBooleano - 65)) | (1L << (NumeroDecimale - 65)) | (1L << (NumeroEsadecimale - 65)) | (1L << (LiteralEsadecimale - 65)) | (1L << (TypeKeyword - 65)) | (1L << (Int - 65)) | (1L << (Uint - 65)) | (1L << (Byte - 65)) | (1L << (Fixed - 65)) | (1L << (Ufixed - 65)) | (1L << (Identifier - 65)) | (1L << (LiteralStringa - 65)))) != 0)) {
					{
					...
					while (_la==T__55) {
						{
						{
						setState(794); match(T__55);
						setState(795); expression(0);
						}
						}
						setState(800);
						_errHandler.sync(this);
	...
	public final TipiExpressionContext tipiExpression() throws RecognitionException {
		...
		try {
			...
			case Identifier:
				enterOuterAlt(_localctx, 2);
				{
				setState(807); tipiDefinitiUtente();
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public final TipiPrimitiviContext tipiPrimitivi() throws RecognitionException {
		...
		try {
			...
			setState(816);
			_la = _input.LA(1);
			if ( !(_la==T__68 || _la==T__51 || ((((_la - 70)) & ~0x3f) == 0 && ((1L << (_la - 70)) & ((1L << (T__11 - 70)) | (1L << (T__10 - 70)) | (1L << (T__6 - 70)) | (1L << (Int - 70)) | (1L << (Uint - 70)) | (1L << (Byte - 70)) | (1L << (Fixed - 70)) | (1L << (Ufixed - 70)))) != 0)) ) {
			_errHandler.recoverInline(this);
			}
			consume();
			}
	...
	public final OperatoriMoltiplicazioneContext operatoriMoltiplicazione() throws RecognitionException {
		...
		try {
			...
			setState(826);
			_la = _input.LA(1);
			if ( !(((((_la - 43)) & ~0x3f) == 0 && ((1L << (_la - 43)) & ((1L << (T__38 - 43)) | (1L << (T__21 - 43)) | (1L << (T__5 - 43)))) != 0)) ) {
			_errHandler.recoverInline(this);
			}
			consume();
			}
	...
	public final OperatoriRelazionaliContext operatoriRelazionali() throws RecognitionException {
		...
		try {
			...
			setState(828);
			_la = _input.LA(1);
			if ( !(((((_la - 31)) & ~0x3f) == 0 && ((1L << (_la - 31)) & ((1L << (T__50 - 31)) | (1L << (T__48 - 31)) | (1L << (T__25 - 31)) | (1L << (T__9 - 31)))) != 0)) ) {
			_errHandler.recoverInline(this);
			}
			consume();
			}
	...
	public final OperatoriAssegnazioneContext operatoriAssegnazione() throws RecognitionException {
		...
		try {
			...
			setState(832);
			_la = _input.LA(1);
			if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__80) | (1L << T__79) | (1L << T__70) | (1L << T__66) | (1L << T__65) | (1L << T__60) | (1L << T__56) | (1L << T__54) | (1L << T__39) | (1L << T__36) | (1L << T__33))) != 0)) ) {
			_errHandler.recoverInline(this);
			}
			consume();
			}
	...
	public boolean sempred(RuleContext _localctx, int ruleIndex, int predIndex) {
		switch (ruleIndex) {
		case